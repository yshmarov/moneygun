...
class Users::Organizations::MembershipRequestsController < ApplicationController
  ...
  def index
    organization_ids = current_user.organization_requests.pending.select(:organization_id)
  ...
  def destroy
    ...
    redirect_to user_organizations_membership_requests_path, notice: t(".success")
  end
