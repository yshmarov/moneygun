...
class Users::Organizations::InvitationsControllerTest < ActionDispatch::IntegrationTest
  setup do
  ...
  test "should get index" do
    get user_organizations_invitations_url
  ...
  test "should approve invitation" do
    assert_difference "@unassociated_user.memberships.count", 1 do
      patch approve_user_organizations_invitation_url(@invitation)
    end
  ...
  test "should reject invitation" do
    assert_difference "@unassociated_user.memberships.count", 0 do
      patch reject_user_organizations_invitation_url(@invitation)
    end
  ...
  test "should not approve another user's invitation" do
    ...
    patch approve_user_organizations_invitation_url(other_user_invitation)
    assert_redirected_to user_organizations_invitations_url
  ...
  test "should not reject another user's invitation" do
    ...
    patch reject_user_organizations_invitation_url(other_user_invitation)
    assert_redirected_to user_organizations_invitations_url
    assert_equal I18n.t("invitations.errors.not_found"), flash[:alert]
  end
end
