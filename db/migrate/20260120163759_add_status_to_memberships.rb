class AddStatusToMemberships < ActiveRecord::Migration[8.1]
  def change
    ...
    remove_index :memberships, [:organization_id, :user_id], name: "index_memberships_on_organization_id_and_user_id"
    remove_index :memberships, [:user_id, :organization_id], name: "index_memberships_on_user_id_and_organization_id"
